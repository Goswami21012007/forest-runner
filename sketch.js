...
var coinS,horseImg,horseG,horseRunner
function preload(){
...
horseImg=loadImage("horse/horse1.png")
horseRunner=loadAnimation("horse/horse1.png","horse/horse2.png","horse/horse3.png","horse/horse4.png")
...
function horse(){
  if (frameCount%140===0){
    var horse=createSprite(width/2,height-49,534,680)
